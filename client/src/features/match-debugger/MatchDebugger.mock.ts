...
export const debugMock: DebugDiagnosis = {
  ...
  diagnosis:
    ...
    'This is the 5th GROVE FLEET SERVICES conflict of this type in the last 6 months.',
  rootCause: 'sap_already_matched',
  vendorContext: 'GROVE FLEET SERVICES — recurring SAP conflict (5th occurrence in 6 months)',
  suggestedFix:
