...
// Default mock uses BNK-001 (APEX SYSTEMS INC date tolerance miss).
...
export const debugMock: DebugDiagnosis = {
  ...
  diagnosis:
    'The bank recorded this APEX SYSTEMS INC payment on 2026-04-28, but the matching SAP entry ' +
  ...
  vendorContext:
    'APEX SYSTEMS INC has an average posting delay of 4.2 days across the last 6 months. ' +
    'This exact pattern appeared 4 times in that period. The Brain recommends a ' +
    '5-day tolerance window for this vendor.',
  suggestedFix:
    'Raise the date tolerance for APEX SYSTEMS INC to 5 days. This would resolve this item ' +
