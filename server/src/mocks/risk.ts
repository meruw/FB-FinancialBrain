  ...
  flags: [
    {
      ...
      description:
        ...
        'same description (APEX SYSTEMS INC PAYMENT SUPPLEMENT). Only one SAP entry exists for this amount.',
    },
    {
      type: 'vendor_anomaly',
      description:
        'APEX SYSTEMS INC has never had a duplicate payment in the last 6 months of Brain history. ' +
        'This is an anomaly, not a known pattern.',
    },
  ],
  recommendation: 'escalate',
  brainBasis:
    'APEX SYSTEMS INC match success rate is 73% with a known date-delay pattern, but no prior ' +
